"""
NOTE: This documentation is out of date; several sensors have been added! Adding that code here for consistency sake. Documentation here is still correct; just now incomplete.
The other repository is my primary use one, which is why I'm not updating here.
